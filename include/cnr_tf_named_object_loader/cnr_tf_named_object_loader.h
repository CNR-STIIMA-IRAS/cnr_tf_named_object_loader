...
using object_t = moveit_msgs::msg::CollisionObject;
...
{
public:
  explicit TFNamedObjectsManager(const rclcpp::Node::SharedPtr& node);
  ...
  bool addObjects(const objects_t& objs, double timeout_s, const std::vector<std_msgs::msg::ColorRGBA>& colors, std::string& what);
...
protected:
  ...
  public:
    ...
    explicit TFPublisherThread(const rclcpp::Node::SharedPtr& node, const std::string& tf_obj_frame,
                               const std::string& tf_reference_frame, const geometry_msgs::msg::Pose& pose);
    bool exit();
  ...
  bool applyAndCheck(const std::vector<moveit_msgs::msg::CollisionObject>& cov,
                     const std::vector<std_msgs::msg::ColorRGBA>& colors, const double& timeout_s, std::string& what);
...
moveit_msgs::msg::CollisionObject toCollisionObject(const object_t& obj);
